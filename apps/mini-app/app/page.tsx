...
function TelegramAppContent() {
  ...
  useEffect(() => {
    ...
    if (hasWallet) {
      ...
      const isInOnboardingFlow = ["passkey-setup", "passkey-mandatory", "pin-setup", "pin-confirm", "wallet-creating", "wallet-ready"].includes(navigation.screen);
...
function ComingSoonScreen() {
  return (
    ...
    >
      ...
      >
        CC Bot Wallet is currently in private beta. We're working hard to bring you the best Canton Network experience.
      </motion.p>
      ...
      <motion.div
        ...
        style={{ background: 'linear-gradient(90deg, #875CFF, #D5A5E3)' }}
      />
      ...
      <motion.div
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.5 }}
        className="bg-white/5 border border-white/10 rounded-2xl p-6 max-w-sm text-center"
      >
        <p className="text-[#FFFFFC]/80 text-sm">
          Stay tuned for updates. Follow us for the latest news about our launch.
        </p>
      </motion.div>
      ...
      <motion.p
        ...
        className="mt-12 text-[#FFFFFC]/30 text-xs"
      >
